...
implements SupervisorPacket {
	...
	/**
	 * Parses a REPDATA packet and instantiate a new RepData object offering method to retrieve the packet's fields
	 * @param bb the bytebuffer containing the REPDATA packet
	 * @return an object representing this packet
	 * @throws MalformedPacketException if the expecting REPDATA packet is malformed
	 */
	...
	throws MalformedPacketException {
		...
		packet.position(PacketFields.getLength(PacketFields.OPCODE, PacketFields.ID, PacketFields.MIMETYPE, PacketFields.LENGHT));
