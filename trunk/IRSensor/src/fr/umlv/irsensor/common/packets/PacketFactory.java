...
public class PacketFactory {
  ...
  public static ByteBuffer createSetConfPacket(int id, CatchArea area,
    ...
    int bufSize = PacketFields.getLength(PacketFields.OPCODE, PacketFields.ID,
        PacketFields.CATCH_AREA, PacketFields.CLOCK, PacketFields.AUTONOMY,
        PacketFields.QUALITY, PacketFields.PAYLOAD, PacketFields.IP,
        PacketFields.ID);
    final ByteBuffer buffer = ByteBuffer.allocate(bufSize);
  ...
  public static ByteBuffer createReqData(int id, CatchArea area, int quality,
      int date) {
    int bufSize = PacketFields.getLength(PacketFields.OPCODE, PacketFields.ID,
        PacketFields.CATCH_AREA, PacketFields.QUALITY, PacketFields.DATE);
    final ByteBuffer buffer = ByteBuffer.allocate(bufSize);
    int index = 0;
  ...
  /**
   * Returns a new REPDATA packet. | Opcode | Id | Datas |
   * 
   * @param id sensor id.
   * @param data data sensor to reply.
   * @return bytebuffer corresponding to REPDATA packet.
   */
  public static ByteBuffer createRepData(int id, int mimetype, int len,
      byte[] data) {
    int bufSize = PacketFields.getLength(PacketFields.OPCODE, PacketFields.ID,
